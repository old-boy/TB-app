<template>
  <div class="login-container">
    <el-form ref="forgotForm" :model="forgotForm" :rules="forgotRules" class="login-form register-form" autocomplete="on" label-position="left">
      <transition name="fade-transform" mode="out-in">
<div class="login-pannel">
        <div class="title-container pannel-header">
          <h3 class="title">忘记密码</h3>
          <p class="des">Forget The Password</p>
        </div>
      ...
      <el-button :loading="loading" type="primary" style="width:100%;" @click.native.prevent="handleForgot">重置密码</el-button>
        </div>
      </div>
      </transition>
    </el-form>
...
export default {
  ...
  mounted() {
    ...
    } else if (this.forgotForm.verficationCode === ''){

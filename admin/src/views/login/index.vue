...
<div class="login-pannel">
        <div class="title-container pannel-header">
          ...
          <p class="des">Backenf of DeepShift</p>
        </div>
      ...
      <div class="online-btn">
        <el-button type="text" class="text-btn" @click="handleRegister">账号注册</el-button>
        <el-button type="text" class="text-btn" @click="handleForgot">忘记密码</el-button>
      </div>
